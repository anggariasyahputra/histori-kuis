...
use App\Http\Controllers\Api\ChapterMaterialController;
...
Route::prefix('/leaderboards')->middleware(AUTH_MIDDLEWARES)
    ->controller(LeaderboardController::class)->group(function () {
        Route::get('/', 'index');
    });
...
Route::prefix('/chapter-materials')->middleware(AUTH_MIDDLEWARES)
    ->controller(ChapterMaterialController::class)->group(function () {
        Route::get('/chapter/{chapterId}', 'index');
        Route::post('/', 'store');
        Route::delete('/{id}', 'destroy');
    });
...
Route::prefix('/courses')->middleware(AUTH_MIDDLEWARES)
    ->controller(CourseController::class)->group(function () {
        Route::post('/history-class', 'historyForClass');
        Route::get('/{id}', 'show');
        Route::put('/{id}', 'update');
        Route::delete('/{id}', 'destroy');
