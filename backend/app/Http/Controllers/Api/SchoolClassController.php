...
class SchoolClassController extends Controller
{
    ...
    {
        $user = $this->getUser();
        abort_if(!$user->hasPermission(PermissionType::SCHOOL_CLASS_VIEW) && !$user->hasPermission(PermissionType::EXAM_CREATE), 403);
        $validated = $request->validated();

            $school_classes = SchoolClass::with(['faculty', 'students' => function ($query) {
