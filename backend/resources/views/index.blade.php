...
<head>
    ...
    <meta name="author" content="{{ config('custom.app.app_author') }}">
  ...
  <script type="module" crossorigin src="/assets/Fd2qqPO7.js"></script>
  <link rel="stylesheet" crossorigin href="/assets/BrfheRAT.css">
</head>

<body>
    <div class="pre-load-container">
        <img height="80px" src="/favicon.ico" alt="app icon">
