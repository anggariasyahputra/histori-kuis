...
const HistoryHub = lazy(() => import('./pages/HistoryHub/HistoryHub'));
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: 'leaderboards',
                        element: <Suspense key='leaderboards' fallback={<SuspenseLoading />}><Leaderboards /></Suspense>
                    },
                    {
                        path: 'history-questions',
                        element: <Suspense key='history-questions' fallback={<SuspenseLoading />}><HistoryHub /></Suspense>
                    },
                    {
                        path: 'faculties',
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                path: 'new',
                                element: <Suspense key='create-exam' fallback={<SuspenseLoading />}><CreateExamPage /></Suspense>
                            },
                            {
                                path: ':id',
                                children: [
