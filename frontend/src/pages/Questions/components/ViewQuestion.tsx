                        ...
                        <div className={globalStyles.formContent}>
                            {
                                queryData.data ? (
                                    <form onSubmit={(e: SyntheticEvent<HTMLFormElement, SubmitEvent>) => {
                                        ...
                                        <input name='level' readOnly hidden value={queryData.data.level} />
                                        <div className={globalStyles.groupInputs}>
                                            ...
                                            <div className={globalStyles.wrapItem}>
                                                <label htmlFor='video'>Ganti video soal (opsional)</label>
                                                <input id='video' name='video' disabled={disabledUpdate} accept='video/mp4,video/webm,video/ogg' type='file' />
                                                {queryData.data.videoUrl ?
                                                    <video controls style={{ maxWidth: '100%', maxHeight: 220 }} src={queryData.data.videoUrl} /> :
                                                    <small>Belum ada video untuk soal ini.</small>
                                                }
                                            </div>
                                            {
                                                    ...
                                                    <div
                                                        ...
                                                        <div className={styles.wrapLabel}>
                                                            <label className={styles.answerChoice}>
                                                                <input type='radio' name='correct_answer' checked={option.key === trueOptionKey} disabled={disabledUpdate} onChange={() => setTrueOptionKey(option.key)} />
