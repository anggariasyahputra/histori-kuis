...
export default function Subject() {
    ...
    const [chapterToDelete, setChapterToDelete] = useState<Chapter>();
    ...
    const handleDeleteChapter = async () => {
        ...
        await apiDeleteChapter(chapterToDelete.id);
    };
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <div className={styles.cardBottom}>
                                                        ...
                                                        <small className={styles.chapterLevels}>
                                                            {chapter.difficultyLevels?.length ?
                                                                `Tingkat: ${chapter.difficultyLevels.map(level => level === 'easy' ? 'Mudah' : level === 'medium' ? 'Sedang' : 'Sulit').join(', ')}` :
                                                                'Belum ada tingkat soal'}
                                                        </small>
                                                    </div>
                                                    {permissions.has('subject_update') ?
                                                        <button
